...
bamsaur(wear, degree = 1, interval = "confidence", level = 0.95)
...
random_sample <- MBsimple[sample(1:nrow(MBsimple), size = 25, replace = F),]
bamsaur(wear, ref_pop = random_sample, level = 0.9)
```
