...
#output
  ...
  cat("AIC:"); cat("\t"); cat("\t"); cat(round(lin.aic, 2)); cat("\n")
  cat("BIC:"); cat("\t"); cat("\t"); cat(round(lin.bic, 2)); cat("\n")
  ...
  cat("AIC:"); cat("\t"); cat("\t"); cat(round(quad.aic, 2)); cat("\n")
  cat("BIC:"); cat("\t"); cat("\t"); cat(round(quad.bic, 2)); cat("\n")
